...
namespace com.ptvgroup.xserver.vehicleprofile 
{
    ...
    public partial class Engine : object, System.ComponentModel.INotifyPropertyChanged {
        ...
        private com.ptvgroup.xserver.types.ConsumptionFactorAtSpeed[] consumptionFactorsPerSpeedField;
        ...
        public bool fuelConsumptionSpecified {
            ...
            set {
                ...
                this.RaisePropertyChanged("fuelConsumptionSpecified");
                    ...
                    [System.Xml.Serialization.XmlElementAttribute("consumptionFactorsPerSpeed", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public com.ptvgroup.xserver.types.ConsumptionFactorAtSpeed[] consumptionFactorsPerSpeed {
            get {
                return this.consumptionFactorsPerSpeedField;
            }
            set {
                this.consumptionFactorsPerSpeedField = value;
                this.RaisePropertyChanged("consumptionFactorsPerSpeed");
            }
        }
