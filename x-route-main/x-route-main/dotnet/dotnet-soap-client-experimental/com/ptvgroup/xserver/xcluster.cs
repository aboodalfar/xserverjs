...
namespace com.ptvgroup.xserver.xcluster 
{
    ...
    public partial class XClusterClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xcluster.XCluster>, com.ptvgroup.xserver.xcluster.XCluster {
        ...
        public XClusterClient() :
            this("http://localhost:50000/services/ws/XCluster/experimental") {
        }

        public XClusterClient(string baseUri ) :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XCluster/experimental/")) {
        }
