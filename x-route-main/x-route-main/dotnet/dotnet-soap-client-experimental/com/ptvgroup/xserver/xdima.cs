...
namespace com.ptvgroup.xserver.xdima 
{
    ...
    public partial class XDimaClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xdima.XDima>, com.ptvgroup.xserver.xdima.XDima {
        ...
        public XDimaClient() :
            this("http://localhost:50000/services/ws/XDima/experimental") {
        }

        public XDimaClient(string baseUri ) :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XDima/experimental/")) {
        }
