...
namespace com.ptvgroup.xserver.xtour 
{
    ...
    public partial class XTourClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xtour.XTour>, com.ptvgroup.xserver.xtour.XTour {
        ...
        public XTourClient() :
            this("http://localhost:50000/services/ws/XTour/experimental") {
        }

        public XTourClient(string baseUri ) :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XTour/experimental/")) {
        }
