...
namespace com.ptvgroup.xserver.xdata 
{
    ...
    public partial class XDataClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xdata.XData>, com.ptvgroup.xserver.xdata.XData {
        ...
        public XDataClient() :
            this("http://localhost:50000/services/ws/XData") {
        }

        public XDataClient(string baseUri , string version="") :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XData/"+version)) {
        }
