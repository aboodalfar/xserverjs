...
namespace com.ptvgroup.xserver.xlocate 
{
    ...
    public partial class XLocateClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xlocate.XLocate>, com.ptvgroup.xserver.xlocate.XLocate {
        ...
        public XLocateClient() :
            this("http://localhost:50000/services/ws/XLocate") {
        }

        public XLocateClient(string baseUri , string version="") :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XLocate/"+version)) {
        }
