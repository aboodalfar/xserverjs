...
namespace com.ptvgroup.xserver.xmap 
{
    ...
    public partial class XMapClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xmap.XMap>, com.ptvgroup.xserver.xmap.XMap {
        ...
        public XMapClient() :
            this("http://localhost:50000/services/ws/XMap") {
        }

        public XMapClient(string baseUri , string version="") :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XMap/"+version)) {
        }
