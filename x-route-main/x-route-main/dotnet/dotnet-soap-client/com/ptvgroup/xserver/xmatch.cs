...
namespace com.ptvgroup.xserver.xmatch 
{
    ...
    public partial class XMatchClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xmatch.XMatch>, com.ptvgroup.xserver.xmatch.XMatch {
        ...
        public XMatchClient() :
            this("http://localhost:50000/services/ws/XMatch") {
        }

        public XMatchClient(string baseUri , string version="") :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XMatch/"+version)) {
        }
