...
namespace com.ptvgroup.xserver.xroute 
{
    ...
    public partial class XRouteClient : System.ServiceModel.ClientBase<com.ptvgroup.xserver.xroute.XRoute>, com.ptvgroup.xserver.xroute.XRoute {
        ...
        public XRouteClient() :
            this("http://localhost:50000/services/ws/XRoute") {
        }

        public XRouteClient(string baseUri , string version="") :
            this(new System.ServiceModel.BasicHttpBinding { MaxReceivedMessageSize = System.Int32.MaxValue }, new System.ServiceModel.EndpointAddress(baseUri+"/services/ws/XRoute/"+version)) {
        }
